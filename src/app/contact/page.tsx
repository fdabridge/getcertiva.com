        ...
        <div className="mx-auto grid max-w-5xl gap-12 px-6 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            <div className="rounded-2xl border border-gray-200 bg-[var(--certiva-mist)] p-6">
              <h3 className="text-lg font-bold text-[var(--text-dark)]">What the demo covers</h3>
              <ul className="mt-4 space-y-3 text-sm text-[var(--text-mid)]">
              ...
              <div className="mt-6 border-t border-gray-200 pt-6">
                <p className="text-sm font-semibold text-[var(--text-dark)]">Direct contact</p>
                <p className="mt-2 text-sm text-[var(--text-mid)]">hello@getcertiva.com</p>
